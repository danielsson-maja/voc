...
public class List extends org.python.types.Object {
    ...
    */
    ...
    public org.python.Object sort(final org.python.Object key, org.python.Object reverse) {
        ...
        long temp = 0;
        for (int i = 0; i < listLen.value - 1; i++) {
            for (int j = 0; j < listLen.value - i - 1; j++) {
                if (((org.python.types.Int)this.__getitem__(org.python.types.Int.getInt(j))).value > ((org.python.types.Int)this.__getitem__(org.python.types.Int.getInt(j + 1))).value) {
                    temp = ((org.python.types.Int)this.__getitem__(org.python.types.Int.getInt(j))).value;
                    this.__setitem__(org.python.types.Int.getInt(j), (this.__getitem__(org.python.types.Int.getInt(j+1))));
                    this.__setitem__(org.python.types.Int.getInt(j+1), org.python.types.Int.getInt(temp));
                }
            }
        }

        if (reverse == org.python.types.Bool.TRUE) {
            this.reverse();
        }
        return org.python.types.NoneType.NONE;
    }
